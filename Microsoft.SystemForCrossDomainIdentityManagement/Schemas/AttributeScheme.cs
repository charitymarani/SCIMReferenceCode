...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        public IReadOnlyCollection<AttributeScheme> SubAttributes
        {
            get
            {
                return this.subAttributesWrapper.Count == 0? null: this.subAttributesWrapper;
            }
        }
        [DataMember(Name = AttributeNames.CanonicalValues)]
        public IReadOnlyCollection<string> CanonicalValues
        {
            get
            {
                return this.canonicalValuesWrapper.Count==0 ? null: this.canonicalValuesWrapper;
            }
        }
        [DataMember(Name = AttributeNames.ReferenceTypes)]
        public IReadOnlyCollection<string> ReferenceTypes
        {
            get
            {
                return this.referenceTypesWrapper.Count==0 ? null : this.referenceTypesWrapper;
            }
        }
